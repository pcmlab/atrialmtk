...
x_list_All = np.concatenate([xlist_1, xlist_Endo])
y_list_All = np.concatenate([ylist_1, ylist_Endo])
z_list_All = np.concatenate([zlist_1, zlist_Endo])
...
Elems_2 = np.concatenate([elems, Elems_Endo, Elems_Ln])
