...
pts, elems, fiber, _ = utils.read_carp(base_dir_bi, "BB_structures", return_surface=False)
M_XYZ_1 = utils.mp_calc_ele_4(pts, elems)
mname = base_dir_bi + "Aux_2"
utils.write_carp(M_XYZ_1, elems, fiber, None, mname)
shutil.copyfile(base_dir_bi + "Aux_2.pts", base_dir_bi + "BB_structures.vpts")
utils.write_carp(pts, elems, fiber, None, mname)
shutil.copyfile(base_dir_bi + "Aux_2.lon", base_dir_bi + "BB_structures.vec")
